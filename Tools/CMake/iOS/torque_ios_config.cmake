if("${TORQUE_APPLE_IOS_PLATFORM}" STREQUAL "")
	message(FATAL_ERROR "Please set TORQUE_APPLE_IOS_PLATFORM platform.")
endif()
...
#sfx
advanced_set(TORQUE_SFX_VORBIS "Vorbis Sound" BOOL OFF)
advanced_set(TORQUE_THEORA "Theora Video Support" BOOL OFF)
advanced_set(TORQUE_SFX_OPENAL "OpenAL Sound" BOOL OFF)

advanced_set(TORQUE_SHIPPING "T3D Shipping build?" BOOL ON)
advanced_set(TORQUE_DEDICATED "Torque dedicated" BOOL OFF) # disables compiling in gfx and sfx frontend functionality

advanced_set(TORQUE_TOOLS "Enable or disable the tools" BOOL OFF)

#testing
advanced_set(TORQUE_TESTING "Unit test build" BOOL OFF)
...
set(IOS_PLATFORM ${TORQUE_APPLE_IOS_PLATFORM} CACHE STRING "Type of iOS Platform")

# check the platform selection and setup for developer root
if (${TORQUE_APPLE_IOS_PLATFORM} STREQUAL "OS")
    set(IOS_PLATFORM_LOCATION "iPhoneOS.platform")

    # this causes the installers to properly locate the output libraries
    set(CMAKE_XCODE_EFFECTIVE_PLATFORMS "-iphoneos")

elseif (${TORQUE_APPLE_IOS_PLATFORM} STREQUAL "SIMULATOR")
    set(IOS_PLATFORM_LOCATION "iPhoneSimulator.platform")

    # this causes the installers to properly locate the output libraries
    set(CMAKE_XCODE_EFFECTIVE_PLATFORMS "-iphonesimulator")

else (${TORQUE_APPLE_IOS_PLATFORM} STREQUAL "OS")
    message(FATAL_ERROR
        "Unsupported IOS_PLATFORM value selected.  Please choose OS or SIMULATOR.")

endif (${TORQUE_APPLE_IOS_PLATFORM} STREQUAL "OS")
...
else (${TORQUE_IOS_PLATFORM} STREQUAL "OS")
  set(IOS_ARCH i386)
endif (${TORQUE_IOS_PLATFORM} STREQUAL "OS")
