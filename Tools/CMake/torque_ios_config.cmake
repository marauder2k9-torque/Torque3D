...
if(APPLE)
   set(TORQUE_APPLE_TARGET "" CACHE STRING "The apple target")
    ...
    if("${TORQUE_APPLE_TARGET}" STREQUAL "")
	    message(FATAL_ERROR "Please set TORQUE_APPLE_TARGET first, if you want to target ios also set TORQUE_IOS_PLATFORM")
    endif()
    ...
    if (${TORQUE_APPLE_TARGET} STREQUAL "macOS")
    ...
    endif (${TORQUE_APPLE_TARGET} STREQUAL "macOS")
...
if(IOS)
    ...
    if (NOT DEFINED TORQUE_IOS_PLATFORM)
        message(FATAL_ERROR "Please set TORQUE_IOS_PLATFORM if you want to build for IOS")
    endif (NOT DEFINED TORQUE_IOS_PLATFORM)
    ...
    # set up iOS developer location
    set(CMAKE_IOS_DEVELOPER_ROOT
    "/Applications/Xcode.app/Contents/Developer/Platforms/${IOS_PLATFORM_LOCATION}/Developer" CACHE PATH "Location of ios platform.")
  ...
  else (${TORQUE_IOS_PLATFORM} STREQUAL "SIMULATOR")
    set (IOS_ARCH x86_64)
