...
class GuiOffscreenCanvasNew : public GuiCanvasNew
{
public:
   typedef GuiCanvasNew Parent;
   
   GuiOffscreenCanvasNew();
   ~GuiOffscreenCanvasNew();
   ...
   DECLARE_CONOBJECT(GuiOffscreenCanvasNew);
...
public:
   static Vector<GuiOffscreenCanvasNew*> sList;
   static GuiOffscreenCanvasNew* sActiveOffscreenCanvas;
};
